...
function Home() {
    ...
    <section className="container w-full lg:px-0 px-5 lg:w-3/4 mx-auto min-h-screen">
      <h3 className="text-3xl font-bold text-center p-5">
        Detweiler
      </h3>
      <div className="flex gap-10 justify-center items-center flex-col lg:flex-row mt-10">
        ...
        <div className="absolute inset-0 bg-rose-500/50 opacity-50 rounded-xl lg:rounded-l-xl animate-pulse-color"></div>
        </div>
